...
public class PopUp3 extends JFrame implements ActionListener{
	...
	public PopUp3(Control c, Model m, View v) {
		...
		jpMain.setPreferredSize(new Dimension(300,200));
		jpText.setPreferredSize(new Dimension(300,60));
		jpButtons.setPreferredSize(new Dimension(300,140));
		...
		if(model.isMenu()) {
			...
			jpMain.setPreferredSize(new Dimension(300,220));
			jpText.setPreferredSize(new Dimension(300,60));
			jpButtons.setPreferredSize(new Dimension(300,160));
